...
export const MOCK_DEVICES: Device[] = [
  { id: 'dev_001', slug: 'light.living_room', friendlyName: 'Living Room Light', aliases: ['living room', 'main light'], room: 'Living Room', category: 'lights', readRoles: [Role.ADMIN, Role.PARENT, Role.CHILD], writeRoles: [Role.ADMIN, Role.PARENT], extraMetadata: {}, llmModelType: 'soon', active: true, createdAt: daysAgo(150), updatedAt: daysAgo(1) },
  { id: 'dev_002', slug: 'light.kitchen', friendlyName: 'Kitchen Light', aliases: ['kitchen'], room: 'Kitchen', category: 'lights', readRoles: [Role.ADMIN, Role.PARENT, Role.CHILD], writeRoles: [Role.ADMIN, Role.PARENT, Role.CHILD], extraMetadata: {}, llmModelType: 'soon', active: true, createdAt: daysAgo(150), updatedAt: daysAgo(2) },
  { id: 'dev_003', slug: 'climate.bedroom_thermo', friendlyName: 'Bedroom Thermostat', aliases: ['bedroom temp', 'thermostat'], room: 'Bedroom', category: 'climate', readRoles: [Role.ADMIN, Role.PARENT], writeRoles: [Role.ADMIN, Role.PARENT], extraMetadata: { minTemp: 60, maxTemp: 85 }, llmModelType: 'immediate', active: true, createdAt: daysAgo(140), updatedAt: daysAgo(0) },
  { id: 'dev_004', slug: 'lock.front_door', friendlyName: 'Front Door Lock', aliases: ['front door', 'main door'], room: 'Entryway', category: 'security', readRoles: [Role.ADMIN, Role.PARENT], writeRoles: [Role.ADMIN], extraMetadata: {}, llmModelType: 'immediate', active: true, createdAt: daysAgo(130), updatedAt: daysAgo(1) },
  { id: 'dev_005', slug: 'cover.garage_door', friendlyName: 'Garage Door', aliases: ['garage'], room: 'Garage', category: 'garage', readRoles: [Role.ADMIN, Role.PARENT], writeRoles: [Role.ADMIN, Role.PARENT], extraMetadata: {}, llmModelType: 'immediate', active: true, createdAt: daysAgo(130), updatedAt: daysAgo(3) },
  { id: 'dev_006', slug: 'media_player.tv', friendlyName: 'Living Room TV', aliases: ['tv', 'television'], room: 'Living Room', category: 'media', readRoles: [Role.ADMIN, Role.PARENT, Role.CHILD], writeRoles: [Role.ADMIN, Role.PARENT, Role.CHILD], extraMetadata: {}, llmModelType: 'soon', active: true, createdAt: daysAgo(120), updatedAt: daysAgo(0) },
  { id: 'dev_007', slug: 'appliance.dishwasher', friendlyName: 'Dishwasher', aliases: ['dishes'], room: 'Kitchen', category: 'appliance', readRoles: [Role.ADMIN, Role.PARENT], writeRoles: [Role.ADMIN, Role.PARENT], extraMetadata: {}, llmModelType: 'soon', active: true, createdAt: daysAgo(100), updatedAt: daysAgo(5) },
  { id: 'dev_008', slug: 'appliance.washer', friendlyName: 'Washing Machine', aliases: ['washer', 'laundry'], room: 'Laundry Room', category: 'appliance', readRoles: [Role.ADMIN, Role.PARENT], writeRoles: [Role.ADMIN, Role.PARENT], extraMetadata: {}, llmModelType: 'soon', active: false, createdAt: daysAgo(90), updatedAt: daysAgo(20) },
];
...
export const MOCK_AUDITS: Audit[] = [
  { id: 'aud_001', entityType: 'Device', entityId: 'dev_003', action: 'UPDATE', userId: 'usr_001', changes: { llmModelType: ['soon', 'immediate'] }, notes: 'Switched thermostat to immediate LLM', createdAt: minsAgo(15) },
