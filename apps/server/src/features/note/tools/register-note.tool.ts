...
const RegisterNoteToolSchema = z.object({
  ...
  readRoles: z
    .array(z.string())
    .optional()
    .describe("Roles that can read this note"),
  writeRoles: z
    .array(z.string())
    .optional()
    .describe("Roles that can write to this note"),
});
...
@Tool()
@Injectable()
export class RegisterNoteTool extends ToolHandler<
  typeof RegisterNoteToolSchema,
  RegisterNoteResult
> {
