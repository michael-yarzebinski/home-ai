...
export const MODEL_MAP = {
    [LLMModelTypes.SOON]: { provider: 'gemini', envKey: 'gemini', model: 'gemini-2.5-flash' },
    [LLMModelTypes.IMMEDIATE]: { provider: 'open-ai', envKey: 'nvidia', model: 'z-ai/glm4.7' },
}

@Injectable()
export class LLMProviderService {
    constructor(
        @Inject(LLM_REGISTRY) private readonly providers: Map<LLMModelTypes, LLMServiceBase>,
    ) { }


    async query(params: LLMQueryParams, modelType: LLMModelTypes): Promise<LLMResponse> {
