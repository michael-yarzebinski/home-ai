...
import { RecipeStore } from '../../../features/recipe-saver/stores/recipe.store';
import { Roles } from '../../../common/decorators/roles.decorator';
import { Role } from '@home-ai/shared/domain/role/role';
import { ZodValidationPipe } from '../../../common/pipes/zod-validation.pipe';
import { SearchCriteriaSchema, type SearchCriteriaBase } from '@home-ai/shared/search/search';
import {
  InsertableRecipeSchema, UpdatableRecipeSchema,
  type InsertableRecipe, type UpdatableRecipe,
...
export class RecipesAdminController {
  ...
  create(@Body(new ZodValidationPipe(InsertableRecipeSchema)) dto: InsertableRecipe) {
    return this.recipeStore.create(dto);
  }

  @Put(':id')
  update(@Param('id') id: string, @Body(new ZodValidationPipe(UpdatableRecipeSchema)) dto: UpdatableRecipe) {
