...
import { IngredientStore } from '../../../features/recipe-saver/stores/ingredients.store';
import { Roles } from '../../../common/decorators/roles.decorator';
import { Role } from '@home-ai/shared/domain/role/role';
import { ZodValidationPipe } from '../../../common/pipes/zod-validation.pipe';
import { SearchCriteriaSchema, type SearchCriteriaBase } from '@home-ai/shared/search/search';
import {
  InsertableIngredientSchema, UpdatableIngredientSchema,
  type InsertableIngredient, type UpdatableIngredient,
...
export class IngredientsAdminController {
  ...
  create(@Body(new ZodValidationPipe(InsertableIngredientSchema)) dto: InsertableIngredient) {
    return this.ingredientStore.create(dto);
  }

  @Put(':id')
  update(@Param('id') id: string, @Body(new ZodValidationPipe(UpdatableIngredientSchema)) dto: UpdatableIngredient) {
